...
CREATE TABLE core.archive_test_uuid
(
...
--- change columns with ---
CREATE TABLE core.archive_test_uuid_archived
(
  LIKE core.archive_test_uuid,
  archived_at tracking_at,
  archived_by_cascade bool NOT NULL
);
...
CREATE TABLE core.info_schema_parent_test
(
  id bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  c_text text NOT NULL
);
COMMENT ON TABLE core.info_schema_parent_test IS 'shortname: isp';

CREATE TABLE core.info_schema_child_test
(
  id bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  c_parent_fk bigint NOT NULL REFERENCES core.info_schema_parent_test(id),
  c_text text NOT NULL
);
COMMENT ON TABLE core.info_schema_child_test IS 'shortname: isc';
...
CREATE TABLE core.tag_test
(
  id bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  c_editable text NOT NULL,
  c_hidden text NOT NULL,
  c_obscured text NOT NULL
);


CREATE TABLE core.tracking_test
(
  id bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  c_editable text NOT NULL,
...
CREATE TABLE core.value_map_test
(
  id bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  c_text text NOT NULL UNIQUE,
  c_int int NOT NULL
);
