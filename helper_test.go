...
func (srvApp *httpServerApplication) getRouter() http.Handler {
	...
	r.HandleFunc(endpoint, Get[corearchivetestm.Model](apiEnv, archiveTestStore)).Methods("GET")
	r.HandleFunc(endpoint+"/{id}", GetById[corearchivetestm.Model](apiEnv, archiveTestStore)).Methods("GET")
	...
	r.HandleFunc(endpoint+"/{id}", GetByUuid[corearchivetestm.Model](apiEnv, archiveTestStore)).Methods("GET")
